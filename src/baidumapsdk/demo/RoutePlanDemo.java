...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    MapView mMapView = LocationDemo.mMapView;    // 地图View
    BaiduMap mBaidumap = LocationDemo.mBaiduMap;
    //搜索相关
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapStatusUpdate u4 = MapStatusUpdateFactory.newLatLng(GEO_GUANGZHOU);
